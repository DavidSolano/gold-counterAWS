...
const App = () => {
  ...
  const apiEndpoint = "https://medalsapidsr.azurewebsites.net/jwt/api/country";
  const hubEndpoint = "https://medalsapidsr.azurewebsites.net/medalsHub"
  const usersEndpoint = "https://medalsapidsr.azurewebsites.net/api/users/login";
